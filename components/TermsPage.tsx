  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 animate-in fade-in duration-500">
      ...
      <div className="space-y-6 text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mt-6">2. Uso e Gratuidade do Serviço</h2>
        <p>O Regular MEI é um dashboard de gestão financeira e fiscal destinado a Microempreendedores Individuais (MEI) no Brasil. O uso da plataforma é oferecido gratuitamente. Reservamo-nos o direito de introduzir planos pagos ou alterar a gratuidade a qualquer momento, mediante aviso prévio.</p>

        <h2 className="text-2xl font-bold mt-6">3. Descrição e Descontinuação do Serviço</h2>
        <p>A plataforma oferece ferramentas para acompanhamento de receitas, despesas, limite de faturamento e obrigações fiscais (DAS e DASN). O Regular MEI pode ser descontinuado, total ou parcialmente, a qualquer momento e sem aviso prévio. É responsabilidade exclusiva do usuário manter cópias de segurança (backup) de todos os seus registros e dados financeiros exportáveis da plataforma.</p>

        <h2 className="text-2xl font-bold mt-6">4. Responsabilidade do Usuário</h2>
        ...
        <h2 className="text-2xl font-bold mt-6">5. Limitação de Responsabilidade</h2>
        ...
        <h2 className="text-2xl font-bold mt-6">6. Encerramento da Conta</h2>
